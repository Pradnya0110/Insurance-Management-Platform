...
public class Claim {
	...
	public String toString() {
		return "Claim [customerId=" + customerId + ", policyReferenceId=" + policyReferenceId + ", claimId=" + claimId
				+ ", claimAmount=" + claimAmount + ", claimSubmissionDate=" + claimSubmissionDate + ", beneficiaryName="
				+ beneficiaryName + ", beneficiaryAddress=" + beneficiaryAddress + ", beneficiaryEmail="
				+ beneficiaryEmail + ", beneficiaryContactNo=" + beneficiaryContactNo + ", claimStatus=" + claimStatus
